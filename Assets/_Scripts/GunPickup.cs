...
public class GunPickup : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            bool hasGun = PlayerController.instance.availableGuns.Exists(x=>x.weaponName==theGun.weaponName);
            if (!hasGun)
            {
            ...
            AudioManager.instance.PlaySFX(AudioManager.AudioCode.PickupHealth);
        }
    }
}
